...
import { FaVoteYea, FaFileInvoice, FaTasks, FaFolderOpen } from "react-icons/fa";
import { GiPlantRoots, GiWheat, GiChemicalTank } from "react-icons/gi";
  ...
  return (
    <>
      ...
      <div className="dashboard-grid">
        ...
        {/* ⭐ New: My Documents (Reports + Bills) */}
        <Link to="/MyDocuments" className="dashboard-tile">
